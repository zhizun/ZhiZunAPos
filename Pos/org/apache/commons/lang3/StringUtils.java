...
public class StringUtils
{
  ...
  private static class InitStripAccents
  {
    ...
    static
    {
      ...
      try
      {
        Object localObject5 = Thread.currentThread().getContextClassLoader().loadClass("java.text.Normalizer$Form");
        localObject1 = localObject2;
        localObject2 = ((Class)localObject5).getField("NFD").get(null);
        localObject1 = localObject2;
        localObject5 = Thread.currentThread().getContextClassLoader().loadClass("java.text.Normalizer").getMethod("normalize", new Class[] { CharSequence.class, localObject5 });
      ...
      java6Exception = (Throwable)localObject2;
      java6NormalizerFormNFD = localObject1;
      java6NormalizeMethod = (Method)localObject3;
      sunException = localThrowable;
      sunDecomposeMethod = (Method)localObject4;
    }
  }
}


/* Location:              C:\Users\Administrator\Desktop\classes-dex2jar.jar!\org\apache\commons\lang3\StringUtils.class
