...
public class GetFavListTask extends AsyncTask<String, Void, BaseBean> {
	AppException e;
	private Context context;
	private TaskCallBack taskCallBack;

	public GetFavListTask(Context context, TaskCallBack callBackFunc) {
	...
	protected BaseBean doInBackground(String... params) {
		try {
			return AppContext.getApp().getFavList(params[0], params[1]);
