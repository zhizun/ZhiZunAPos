...
import com.ch.epw.widget.pulltorefresh.LoadingLayout;
...
public class CustomListView extends ListView implements OnScrollListener {
	...
	private final static int LOADING_OVER = 5;
	...
	public void setHasMoreData(boolean hasMoreData) {
		if (!hasMoreData) {
			...
			moreView.setClickable(hasMoreData);
			loadMoreView.setText(getContext().getString(R.string.load_full));
		} else {
			moreProgressBar.setVisibility(View.GONE);
			moreView.setClickable(hasMoreData);
	...
	private void changeHeaderViewByState() {
		...
		case DONE:
			...
			arrowImageView.clearAnimation();
			arrowImageView
					.setImageResource(R.drawable.xsearch_msg_pull_arrow_down);
			tipsTextview.setText("下拉刷新");
			lastUpdatedTextView.setVisibility(View.VISIBLE);
