...
public class SingleSelectTeacherActivity extends BaseActivity {
	...
	private void initView() {
		...
		titleBarView.setTitleText(R.string.title_text_choose_agentteacher);
	...
	class ExpandableAdapter extends BaseExpandableListAdapter {
		...
		public View getChildView(int groupPosition, final int childPosition,
			...
			tv_senddynamic_child_selectstudent_item_name.setText(teacherInfo
					.getName());
			tv_senddynamic_child_selectstudent_item_age.setText(teacherInfo
					.getPost());
	...
	/**
	 * 获取教师列表 创建人：李林中 创建日期：2014-12-9 上午10:42:07 作用： 修改
	 * =================================================== 修改人 修改日期 原因(描述)
	 * ===================================================
	 */
	private class GetTeacherAndClassTask extends
		...
		protected TeacherOrgClassList doInBackground(Boolean... params) {
			...
			try {
				teacherOrgList = AppContext.getApp()
						.getDelegationClassAndTeacher(params[0]);
