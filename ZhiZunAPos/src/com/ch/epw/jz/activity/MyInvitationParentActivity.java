 ...
 * ===================================================
 */
public class MyInvitationParentActivity extends BaseActivity {

	protected static final String TAG = "com.ch.epw.js.activity.MyInvitationParentActivity";
	Context context;
	...
	private TextView tv_yh_list_title;
	...
	private void initView() {
		...
		tv_yh_list_title = (TextView) findViewById(R.id.tv_yh_list_title);
		tv_yh_list_title.setVisibility(View.GONE);
	...
	private void content() {
		...
		mListView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				// 邀请家长
				else if (Constant.INVITE_TYPE_TO_PARENT.equals(invite.getType())) {
					intent = new Intent(context,
		...
		public View getView(final int position, View convertView,
			...
			holder.btn_list_my_invitation_parent_item_invitestatus_recevie
					.setOnClickListener(new OnClickListener() {
						@Override
						public void onClick(View v) {
							recevie = recevieMyInvitation;
							// 如果是邀请老师，直接调AcceptInviteTask
							if (Constant.INVITE_TYPE_TO_TEACHER
									.equals(recevieMyInvitation.getType())) {
								final View myView = View
										.inflate(
												context,
												R.layout.list_my_invitation_receive_item,
												null);
								new AcceptInviteTask(context).execute(
										AppContext.getApp().getToken(),
										recevieMyInvitation.getOrgInviteId(),
										"", "");
							}
							// 邀请家长，调用GetUserChildsTask
							else if (Constant.INVITE_TYPE_TO_PARENT
									.equals(recevieMyInvitation.getType())) {
								new GetUserChildsTask(context,
										recevieMyInvitation, false)
		...
		class ViewHolder {
			...
			protected void resetContentAndListener() {
				if (iv_list_my_invitation_recevie_item_logo != null) {
					iv_list_my_invitation_recevie_item_logo
