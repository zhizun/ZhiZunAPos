 ...
 * GrideView 图片Adapter
 */
public class FriendsGridViewImagesAdapter extends MyBaseAdapter {

	private Context context;// 运行上下文
	private List<Photo> listItems; // 数据集合

	public FriendsGridViewImagesAdapter(Context context, List<Photo> listItems) {
		super();
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (null == convertView) {
			...
			convertView = View.inflate(context, R.layout.friends_list_image_gridview,
					null);
