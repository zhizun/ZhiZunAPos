...
/**
 * 修改绑定手机第1步创建人：李林中 创建日期：2014-12-15 上午9:47:50 作用： 修改
 * =================================================== 修改人 修改日期 原因(描述)
 * ===================================================
 */
public class ChangeBindPhone1Activity extends BaseActivity {

	private TitleBarView titleBarView;
	private Context context;
	private Button btn_nexe_submit_gray, btn_next_submit;
	EditText et_forget_passrword_text;
	TextView tv_bind_phone2_title;
	Result result;
	String phone;
	...
	private void initView() {
		...
		btn_nexe_submit_gray.setText("发送验证码");
		btn_next_submit = (Button) this.findViewById(R.id.btn_next_submit);
		btn_next_submit.setText("发送验证码");
		...
		et_forget_passrword_text.setText(phone);
		...
		tv_bind_phone2_title = (TextView) findViewById(R.id.tv_bind_phone2_title);
		tv_bind_phone2_title.setText("当前绑定的手机号：");
	}
