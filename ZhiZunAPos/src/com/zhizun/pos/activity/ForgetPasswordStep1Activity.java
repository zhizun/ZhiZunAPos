...
/**
 * 忘记密码第1步创建人：李林中 创建日期：2014-12-15 上午9:47:50 作用： 修改
 * =================================================== 修改人 修改日期 原因(描述)
 * ===================================================
 */
public class ForgetPasswordStep1Activity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.forget_passrword_step1);
		context = this;
		initView();
	}
	...
	private void initView() {
		...
		btn_next_submit.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				String phone = et_forget_passrword_text.getText().toString()
						.trim();
				...
				new ValidUserTask().execute(phone);
			}
		});
	...
	private class ValidUserTask extends
			AsyncTask<String, Void, ValidUserResult> {
		AppException e;

		protected ValidUserResult doInBackground(String... params) {
			// TODO Auto-generated method stub
			try {
				validUserResult = ((AppContext) getApplication())
						.validUser(params[0]);
