...
/**
 * 修改绑定手机第3步创建人：李林中 创建日期：2014-12-15 上午9:47:50 作用： 修改
 * =================================================== 修改人 修改日期 原因(描述)
 * ===================================================
 */
public class ChangeBindPhone3Activity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		initView();
		AppManager.getAppManager().finishActivity(ChangeBindPhone2Activity.class);
	}
